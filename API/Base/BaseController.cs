      ...
      public ActionResult<Entity> Delete(Key key)
      {
         try
         {
            ...
            if (erased != null)
            {
               ...
               return Ok(new { status = HttpStatusCode.OK, result = erased, message = "Data Successfully Deleted." });
            }
            return StatusCode(404, new { status = HttpStatusCode.NotFound, result = erased, message = "Data Not Found." });
         }
         catch
         {
