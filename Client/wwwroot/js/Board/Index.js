...
$(document).ready(function () {
   ...
   $.ajax({
      ...
      dataType: 'json',
      url: `https://localhost:8999/api/boards/user/${userId}`,
      data: 'data',
...
const updateBoard = () => {
   ...
   $.ajax({
      ...
      contentType: 'application/json; charset=utf-8',
      dataType: 'json',
      url: 'https://localhost:8999/api/boards/',
...
const deleteModal = (id) => {
   ...
   swal({
      ...
      if (willDelete) {
         $.ajax({
            type: 'DELETE',
            url: `https://localhost:8999/api/boards/${id}`,
            success: function (response) {
...
const createBoard = () => {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://localhost:8999/api/boards/create',
      headers: {
