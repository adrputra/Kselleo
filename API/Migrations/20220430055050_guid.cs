        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "Todo")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberBoards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MemberBoards_Boards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "Boards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CardId = table.Column<int>(type: "int", nullable: false),
                    Comment_ = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberCards_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckListItemsAssigns", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CheckListItemsAssigns_CheckListItems_CheckListItemId",
                        column: x => x.CheckListItemId,
                        principalTable: "CheckListItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CheckListItemsAssigns_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckListItemsAssigns_CheckListItemId",
                table: "CheckListItemsAssigns",
                column: "CheckListItemId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckListItemsAssigns_UserId",
                table: "CheckListItemsAssigns",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberBoards_BoardId",
                table: "MemberBoards",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberBoards_UserId",
                table: "MemberBoards",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberCards_CardId",
                table: "MemberCards",
                column: "CardId");
