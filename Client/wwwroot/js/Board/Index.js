...
$(document).ready(function () {
   ...
   $.ajax({
      ...
      dataType: 'json',
      url: `https://kselleo.eventarry.com/api/boards/user/${userId}`,
      data: 'data',
...
const updateBoard = () => {
   ...
   $.ajax({
      ...
      contentType: 'application/json; charset=utf-8',
      dataType: 'json',
      url: 'https://kselleo.eventarry.com/api/boards/',
...
const deleteModal = (id) => {
   ...
   swal({
      ...
      if (willDelete) {
         $.ajax({
            type: 'DELETE',
            url: `https://kselleo.eventarry.com/api/boards/${id}`,
            success: function (response) {
...
const createBoard = () => {
   ...
   $.ajax({
      type: 'POST',
      url: 'https://kselleo.eventarry.com/api/boards/create',
      headers: {
